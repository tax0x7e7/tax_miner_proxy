...
download() {
    ...
    mkdir -p $dirname
    wget https://raw.githubusercontent.com/tax0x7e7/tax_miner_proxy/master/biyinhezi/tax.miner.proxy -O $dirname/tax.miner.proxy
    wget https://raw.githubusercontent.com/tax0x7e7/tax_miner_proxy/master/biyinhezi/config.yaml -O $dirname/config.yaml
